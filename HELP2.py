...
def start_tkinter_app():
    ...
    def login():
        ...
        if user_entry.get() == username and user_pass.get() == password:
            ...
            messagebox.showwarning("Wrong password", "Please check your password", parent=app)
        elif user_entry.get() != username and user_pass.get() == password:
            messagebox.showwarning("Wrong username", "Please check your username", parent=app)
        else:
            messagebox.showerror("Login Failed", "Invalid Username and password", parent=app)
    ...
    user_pass = ctk.CTkEntry(master=frame, placeholder_text="Password", show="*", height=80, width=500,
                             font=("Lato", 50))
    ...
    class DisplayWindow(ctk.CTk):
        def __init__(self):
            ...
            self.sidebar_button_1 = ctk.CTkButton(self.sidebar_frame, text="On", height=button_height,
                                                  font=("Lato", 50),
            ...
            self.sidebar_button_2 = ctk.CTkButton(self.sidebar_frame, text="Capture", height=button_height,
                                                  font=("Lato", 50),
            ...
            self.sidebar_button_3 = ctk.CTkButton(self.sidebar_frame, text="Settings", height=button_height,
                                                  font=("Lato", 50),
                                                  command=self.open_settings_window)
            self.sidebar_button_3.grid(row=3, column=0, padx=20, pady=button_padding, sticky="ew")

            self.sidebar_button_4 = ctk.CTkButton(self.sidebar_frame, text="Logout", height=button_height,
                                                  font=("Lato", 50),
    ...
    class SettingsWindow(ctk.CTk):
        ...
        def __init__(self):
            ...
            self.box1 = customtkinter.CTkLabel(self.normal_frame, fg_color="#3B3B3B", text="Options", height=80,
                                               font=("Lato", 50), corner_radius=5)
            ...
            self.button2 = customtkinter.CTkButton(self.normal_frame, text="Patient Information", height=80,
                                                   font=("Lato", 50), command=self.open_patient_information_window)
            self.button2.grid(row=2, column=0, padx=75, pady=30, sticky="ew")

            self.button3 = customtkinter.CTkButton(self.normal_frame, text="Further Analysis", height=80,
                                                   font=("Lato", 50), command=self.launchFurtherAnalysis)
            self.button3.grid(row=3, column=0, padx=75, pady=30, sticky="ew")

            self.button4 = customtkinter.CTkButton(self.normal_frame, text="Exit", height=80, font=("Lato", 50),
            ...
            self.scrollable_frame = customtkinter.CTkScrollableFrame(self, label_text="Patient Number",
                                                                     label_font=("Lato", 50), width=550)
            self.scrollable_frame.grid(row=0, column=2, padx=(0, 20), pady=(10, 10), sticky="nsew")
            self.scrollable_frame.grid_columnconfigure(0, weight=1)

            self.scrollable_frame_switches = []
            for i in range(1, 101):
                switch = customtkinter.CTkSwitch(master=self.scrollable_frame, text=f"Patient {i}", height=20,
                                                 font=("Lato", 50))
    ...
    class PatientInformationWindow(ctk.CTk):
        ...
        def setup_ui(self):
            ...
            self.maleRadioButton = ctk.CTkRadioButton(self, text="Male", font=("Lato", 30), variable=self.genderVar,
                                                      value="Male")
            self.maleRadioButton.grid(row=2, column=1, padx=(10, 70), pady=5, sticky="ew")
            self.femaleRadioButton = ctk.CTkRadioButton(self, text="Female", font=("Lato", 30), variable=self.genderVar,
                                                        value="Female")
            ...
            self.choice1 = ctk.CTkCheckBox(self, text="DR", font=("Lato", 30), variable=self.checkboxVar,
                                           onvalue="choice1", offvalue="c1")
            self.choice1.grid(row=3, column=1, padx=(10, 70), pady=5, sticky="ew")
            self.choice2 = ctk.CTkCheckBox(self, text="No DR", font=("Lato", 30), variable=self.checkboxVar,
                                           onvalue="choice2",
                                           offvalue="c2")
            self.choice2.grid(row=3, column=2, padx=(10, 70), pady=5, sticky="ew")
            self.choice3 = ctk.CTkCheckBox(self, text="Consultation Needed", font=("Lato", 30),
                                           variable=self.checkboxVar,
                                           onvalue="choice3", offvalue="c3")
            self.choice3.grid(row=3, column=3, padx=10, pady=5, sticky="ew")

            self.ExitButton = ctk.CTkButton(self, text="Exit", height=80, font=("Lato", 50),
                                            command=self.exit_application)
            self.ExitButton.grid(row=1, column=3, columnspan=1, padx=(10, 18), pady=20, sticky="ew")

            self.SaveButton = ctk.CTkButton(self, text="Save Information", height=80, font=("Lato", 50),
                                            command=self.placeholderFunction)
