...
logo_5_pos = [-logo_5.get_width(), (frame_height - logo_5.get_height()) // 15]
logo_6_pos = [frame_width, (frame_height + logo_5.get_height()) // 2.9]
...
def start_tkinter_app():
   ...
   class DisplayWindow(ctk.CTk):
       def __init__(self):
           ...
           self.sidebar_button_1 = customtkinter.CTkButton(self.sidebar_frame, text="On", command=lambda: self.sidebar_button_event(self.sidebar_button_1))
           ...
           self.sidebar_button_4 = customtkinter.CTkButton(self.sidebar_frame, text="Settings", command=self.open_settings_window)
