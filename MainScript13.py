...
def start_tkinter_app():
    ...
    class SettingsWindow(ctk.CTk):
        ...
        def __init__(self):
            ...
            self.scaling_factor = 1.5  # Local scaling factor for this window
            self.setup_widgets()
        ...
        def setup_widgets(self):
                # Example of applying scaling manually
                font_size = self.scaled_size(50)  # Base font size
            ...
            # Normal frame adjustments
                ...
                self.normal_frame.grid(row=0, column=1, padx=(0, 5), pady=(10, 10), sticky="nsew")
                self.normal_frame.grid_columnconfigure(0, weight=1)
                self.normal_frame.grid_rowconfigure(0, weight=1)

                self.box1 = customtkinter.CTkLabel(self.normal_frame, fg_color="#3B3B3B", text="Options", height=50, font=("Lato", 40), corner_radius=5)
                self.box1.grid(row=0, column=0, padx=(13, 13), pady=(10, 28), sticky="ew")

                self.button1 = customtkinter.CTkButton(self.normal_frame, text="Retake Image", height=50, font=("Lato", 30))
                self.button1.grid(row=1, column=0, padx=75, pady=20, sticky="ew")

                self.button2 = customtkinter.CTkButton(self.normal_frame, text="Patient Information", height=50, font=("Lato", 30), command=self.open_patient_information_window)
                self.button2.grid(row=2, column=0, padx=75, pady=20, sticky="ew")

                self.button3 = customtkinter.CTkButton(self.normal_frame, text="Further Analysis", height=50, font=("Lato", 30), command=self.launchFurtherAnalysis)
                self.button3.grid(row=3, column=0, padx=75, pady=20, sticky="ew")

                self.button4 = customtkinter.CTkButton(self.normal_frame, text="Exit", height=50, font=("Lato", 30), command=self.exit_application)
                self.button4.grid(row=4, column=0, padx=75, pady=20, sticky="ew")
            ...
            # Scrollable frame adjustments
                self.scrollable_frame = customtkinter.CTkScrollableFrame(self, label_text="Patient Number", label_font=("Lato", 40), width=375, height=300)
                self.scrollable_frame.grid(row=0, column=2, padx=(0, 5), pady=(10, 10), sticky="nsew")
                ...
                for i in range(1, 101):
                    ...
                    switch.grid(row=i, column=0, padx=(0, 0), pady=(20, 0))
